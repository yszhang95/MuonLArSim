...
python dump_to_bee.py  --compress pgun_muplus_3gev.hdf5 pgun_muplus_3gev_json
python dump_to_bee.py  --compress pgun_positron_3gev.hdf5 pgun_positron_3gev_json
